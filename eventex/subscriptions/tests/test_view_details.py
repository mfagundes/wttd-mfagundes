...
class DetailTest(TestCase):
    def setUp(self):
        s = Subscription.objects.create(name='Maurício Fagundes', cpf='12345678909', email='mauricio.fagundes@gmail.com', phone='21 2553 3479')
    ...
    def test_html(self):
        ...
        self.assertContains(self.resp, u'Maurício Fagundes')
